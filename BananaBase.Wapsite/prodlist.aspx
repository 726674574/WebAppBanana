<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prodlist.aspx.cs" Inherits="Banana.Wapsite.prodlist" %>
...
<input id="pro_type2" type="hidden" value="<%=pro_type2 %>" />
<div class="header">
        <div class="top">
            <a href="index.aspx" class="Bg50 back"></a><%=type==""?type2name:type %><a href="search.aspx" class="Bg50 search"></a></div>
        <div class="submenu">
            <a href="javascript:;" class="on" onclick="showThistype(this)">推荐<span style="display:none">&uarr;</span></a><a href="javascript:;"
...
<!--<div class="searchBox bdradius6 clf">
  ...
  <input type="submit" class="searchBtn Bg50" value=""/>
</div>-->
...
<div class="prodlist" id="prodlist" style="margin-top:100px">
  ...
  <div class="loadingdata" id="loadingdata">数据加载中请稍候!</div>
...
<script>
    ...
    window.onload = function () {
        ...
        window.onscroll = function () {
            ScrollloadImage();
            loadingData("theList", "index_prolist");
    ...
    function getpro() {
        ...
        var type2 = document.getElementById("pro_type2").value;
        var order = document.getElementsByClassName("on")[0].text;
        var Cont = document.getElementById("theList");
        
        var ajaxdata = "page=" + 0 + "&order=" + order+"&type2="+type2+"&type="+type;
        Ajax.request('/ajax/index_prolist.ashx', {
            data: ajaxdata,
            method: "GET",
            success: function (xhr) {
                if (xhr != "-1") {
    ...
    function showThistype(elm) {
        ...
        var Cont = document.getElementById("theList");
            ...
            var ajaxdata = "page=" + 0 + "&order=" + order + "&type=" + type + "&type2=" + type2;
            Ajax.request('/ajax/index_prolist.ashx', {
                data: ajaxdata,
                method: "GET",
                success: function(xhr) {

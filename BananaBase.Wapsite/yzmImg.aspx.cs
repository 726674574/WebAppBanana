...
namespace Banana.Wapsite
{
    ...
    /// Captcha
    /// </summary>
    public partial class yzmImg : System.Web.UI.Page
    {
        ...
        private void GetText()
        {
            ...
            {
                HttpCookie cookie = new HttpCookie("banana_shop_imgyzm");
                cookie.Values.Add("imgyzm", this.verifyCodeText);
            ...
            else
            {
                ...
                cookie.Values["imgyzm"] = this.verifyCodeText;
                cookie.Expires = DateTime.Now.AddMinutes(30);
                HttpContext.Current.Response.AppendCookie(cookie);
            }
        }

...
{
    /// <summary>
    /// index_cainixihuan 的摘要说明
    /// </summary>
    public class index_cainixihuan : IHttpHandler
    {
        ...
        public string getPro(int page, int pagesize)
        {
            string result = "";
          ...
          <span class=""prodPrice clf""><i class=""red fl"">￥{4}</i> <i class=""fl"">￥{5}</i></span>
           ...
           var list= new ProductBll().GetAll("*", page, pagesize, "", "", " newid()").Entity;

...
{
    public class OrderListBll : BalBase
    {
        #region Auto
        ...
        /// 通过主键查询
        /// </summary>
        public ResultSet<OrderList> GetByPrimaryKey(Int32 primaryKey)
        {
            ...
            Func<Int32, OrderList> op = (_primaryKey) =>
            {
                return new OrderListDal().GetByPrimaryKey(_primaryKey);
            };
            return HandleBusiness<Int32, OrderList>(primaryKey, op, validate);
        }
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<IList<OrderList>> GetAll(string fields, string where, object param, string orderBy)
        {
            ...
            Func<string, string, object, string, IList<OrderList>> op = (_fields, _where, _param, _orderBy) =>
            {
                return new OrderListDal().GetAll(_fields, _where, _param, _orderBy);
            };
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<Page<OrderList>> GetAll(string fields, int pageIndex, int pageSize, string where, object param, string orderBy)
        {
            ...
            Func<string, int, int, string, object, string, Page<OrderList>> op = (_fields, _pageIndex, _pageSize, _where, _param, _orderBy) =>
            {
                int recordCount = 0;

                IList<OrderList> list = new OrderListDal().GetAll(_fields, _pageIndex, _pageSize, _where, _param, _orderBy, out recordCount);
                return new Page<OrderList>(_pageIndex, _pageSize, recordCount, list);
            };
        ...
        public ResultSet Update(string fields, object param, string where)
        {
            ...
            {
                int ret = new OrderListDal().Update(_fields, _param, _where);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()

...
{
    public class StatisticsBll : BalBase
    {
        #region Auto
        ...
        /// 通过主键查询
        /// </summary>
        public ResultSet<Statistics> GetByPrimaryKey(Int32 primaryKey)
        {
            ...
            Func<Int32, Statistics> op = (_primaryKey) =>
            {
                return new StatisticsDal().GetByPrimaryKey(_primaryKey);
            };
            return HandleBusiness<Int32, Statistics>(primaryKey, op, validate);
        }
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<IList<Statistics>> GetAll(string fields, string where, object param, string orderBy)
        {
            ...
            Func<string, string, object, string, IList<Statistics>> op = (_fields, _where, _param, _orderBy) =>
            {
                return new StatisticsDal().GetAll(_fields, _where, _param, _orderBy);
            };

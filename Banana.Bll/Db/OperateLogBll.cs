...
{
    public class OperateLogBll : BalBase
    {
        #region Auto
        ...
        /// 通过主键查询
        /// </summary>
        public ResultSet<OperateLog> GetByPrimaryKey(Int32 primaryKey)
        {
            ...
            Func<Int32, OperateLog> op = (_primaryKey) =>
            {
                return new OperateLogDal().GetByPrimaryKey(_primaryKey);
            };
            return HandleBusiness<Int32, OperateLog>(primaryKey, op, validate);
        }
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<IList<OperateLog>> GetAll(string fields, string where, object param, string orderBy)
        {
            ...
            Func<string, string, object, string, IList<OperateLog>> op = (_fields, _where, _param, _orderBy) =>
            {
                return new OperateLogDal().GetAll(_fields, _where, _param, _orderBy);
            };
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<Page<OperateLog>> GetAll(string fields, int pageIndex, int pageSize, string where, object param, string orderBy)
        {
            ...
            Func<string, int, int, string, object, string, Page<OperateLog>> op = (_fields, _pageIndex, _pageSize, _where, _param, _orderBy) =>
            {
                int recordCount = 0;

                IList<OperateLog> list = new OperateLogDal().GetAll(_fields, _pageIndex, _pageSize, _where, _param, _orderBy, out recordCount);
                return new Page<OperateLog>(_pageIndex, _pageSize, recordCount, list);
            };
        ...
        public ResultSet Update(string fields, object param, string where)
        {
            ...
            {
                int ret = new OperateLogDal().Update(_fields, _param, _where);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()

...
{
    public class ProductBll : BalBase
    {
        #region Auto
        ...
        /// 通过主键查询
        /// </summary>
        public ResultSet<Product> GetByPrimaryKey(Int32 primaryKey)
        {
            ...
            Func<Int32, Product> op = (_primaryKey) =>
            {
                return new ProductDal().GetByPrimaryKey(_primaryKey);
            };
            return HandleBusiness<Int32, Product>(primaryKey, op, validate);
        }
        ...
        {
          return  new ProductDal().AddAndReturn(entity);
        }
        /// <summary>
        /// 获取所有
        /// </summary>
        public ResultSet<IList<Product>> GetAll(string fields, string where, object param, string orderBy)
        {
            ...
            Func<string, string, object, string, IList<Product>> op = (_fields, _where, _param, _orderBy) =>
            {
                return new ProductDal().GetAll(_fields, _where, _param, _orderBy);
            };
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<Page<Product>> GetAll(string fields, int pageIndex, int pageSize, string where, object param, string orderBy)
        {
            ...
            Func<string, int, int, string, object, string, Page<Product>> op = (_fields, _pageIndex, _pageSize, _where, _param, _orderBy) =>
            {
                int recordCount = 0;

                IList<Product> list = new ProductDal().GetAll(_fields, _pageIndex, _pageSize, _where, _param, _orderBy, out recordCount);
                return new Page<Product>(_pageIndex, _pageSize, recordCount, list);
            };
        ...
        /// <returns></returns>
        public ResultSet<Page<Product>> GetJoinAll(string fields, int pageIndex, int pageSize, string where, object param, string orderBy)
        {
            Func<string, int, int, string, object, string, ResultStatus> validate = (_fields, _pageIndex, _pageSize, _where, _param, _orderBy) =>
            {
                if (_pageIndex <= 0)
            ...
            Func<string, int, int, string, object, string, Page<Product>> op = (_fields, _pageIndex, _pageSize, _where, _param, _orderBy) =>
            {
                ...
                IList<Product> list = new ProductDal().GetJoinAll(_fields, _pageIndex, _pageSize, _where, _param, _orderBy, out recordCount);
                return new Page<Product>(_pageIndex, _pageSize, recordCount, list);
            };
        ...
        public ResultSet Update(string fields, object param, string where)
        {
            ...
            {
                int ret = new ProductDal().Update(_fields, _param, _where);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        /// 更新
        /// </summary>
		 public ResultSet Update(Product entity)
        {
            Func<Product, ResultStatus> validate = (_entity) =>
            {
                return new ResultStatus();
            ...
            Func<Product, ResultStatus> op = (_entity) =>
            {
                int ret = new ProductDal().Update(entity);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        public ResultSet DeleteList(string where)
        {
            ...
            {
                int ret = new ProductDal().DeleteList(_where);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        {
            return new ProductDal().GetMaxField(filed);
        }

...
{
    public class AdLocationBll : BalBase
    {
        #region Auto
        ...
        /// 通过主键查询
        /// </summary>
        public ResultSet<AdLocation> GetByPrimaryKey(Int32 primaryKey)
        {
            ...
            Func<Int32, AdLocation> op = (_primaryKey) =>
            {
                return new AdLocationDal().GetByPrimaryKey(_primaryKey);
            };
            return HandleBusiness<Int32, AdLocation>(primaryKey, op, validate);
        }
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<IList<AdLocation>> GetAll(string fields, string where, object param, string orderBy)
        {
            ...
            Func<string, string, object, string, IList<AdLocation>> op = (_fields, _where, _param, _orderBy) =>
            {
                return new AdLocationDal().GetAll(_fields, _where, _param, _orderBy);
            };
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<Page<AdLocation>> GetAll(string fields, int pageIndex, int pageSize, string where, object param, string orderBy)
        {
            ...
            Func<string, int, int, string, object, string, Page<AdLocation>> op = (_fields, _pageIndex, _pageSize, _where, _param, _orderBy) =>
            {
                int recordCount = 0;

                IList<AdLocation> list = new AdLocationDal().GetAll(_fields, _pageIndex, _pageSize, _where, _param, _orderBy, out recordCount);
                return new Page<AdLocation>(_pageIndex, _pageSize, recordCount, list);
            };
        ...
        public ResultSet Update(string fields, object param, string where)
        {
            ...
            {
                int ret = new AdLocationDal().Update(_fields, _param, _where);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        /// 更新
        /// </summary>
		 public ResultSet Update(AdLocation entity)
        {
            Func<AdLocation, ResultStatus> validate = (_entity) =>
            {
                return new ResultStatus();
            ...
            Func<AdLocation, ResultStatus> op = (_entity) =>
            {
                int ret = new AdLocationDal().Update(entity);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        public ResultSet DeleteList(string where)
        {
            ...
            {
                int ret = new AdLocationDal().DeleteList(_where);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        {
            return new AdLocationDal().GetMaxField(filed);
        }

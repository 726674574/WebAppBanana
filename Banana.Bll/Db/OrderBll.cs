...
namespace Banana.Bll.Db
{
    public class OrderBll : BalBase
    {
        ...
        /// 通过主键查询
        /// </summary>
        public ResultSet<Order> GetByPrimaryKey(Int32 primaryKey)
        {
            ...
            Func<Int32, Order> op = (_primaryKey) =>
            {
                return new OrderDal().GetByPrimaryKey(_primaryKey);
            };
            return HandleBusiness<Int32, Order>(primaryKey, op, validate);
        }
        ...
        {
          return  new OrderDal().AddAndReturn(entity);
        }
        /// <summary>
        /// 获取所有
        /// </summary>
        public ResultSet<IList<Order>> GetAll(string fields, string where, object param, string orderBy)
        {
            ...
            Func<string, string, object, string, IList<Order>> op = (_fields, _where, _param, _orderBy) =>
            {
                return new OrderDal().GetAll(_fields, _where, _param, _orderBy);
            };
        ...
        /// 更新
        /// </summary>
		 public ResultSet Update(Order entity)
        {
            Func<Order, ResultStatus> validate = (_entity) =>
            {
                return new ResultStatus();
            ...
            Func<Order, ResultStatus> op = (_entity) =>
            {
                int ret = new OrderDal().Update(entity);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        {
            return new OrderDal().GetMaxField(filed);
        }

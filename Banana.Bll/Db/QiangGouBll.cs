...
{
    public class QiangGouBll : BalBase
    {
        #region Auto
        ...
        /// 通过主键查询
        /// </summary>
        public ResultSet<QiangGou> GetByPrimaryKey(Int32 primaryKey)
        {
            ...
            Func<Int32, QiangGou> op = (_primaryKey) =>
            {
                return new QiangGouDal().GetByPrimaryKey(_primaryKey);
            };
            return HandleBusiness<Int32, QiangGou>(primaryKey, op, validate);
        }
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<IList<QiangGou>> GetAll(string fields, string where, object param, string orderBy)
        {
            ...
            Func<string, string, object, string, IList<QiangGou>> op = (_fields, _where, _param, _orderBy) =>
            {
                return new QiangGouDal().GetAll(_fields, _where, _param, _orderBy);
            };
        ...
        /// 获取所有
        /// </summary>
        public ResultSet<Page<QiangGou>> GetAll(string fields, int pageIndex, int pageSize, string where, object param, string orderBy)
        {
            ...
            Func<string, int, int, string, object, string, Page<QiangGou>> op = (_fields, _pageIndex, _pageSize, _where, _param, _orderBy) =>
            {
                int recordCount = 0;

                IList<QiangGou> list = new QiangGouDal().GetAll(_fields, _pageIndex, _pageSize, _where, _param, _orderBy, out recordCount);
                return new Page<QiangGou>(_pageIndex, _pageSize, recordCount, list);
            };
        ...
        public ResultSet Update(string fields, object param, string where)
        {
            ...
            {
                int ret = new QiangGouDal().Update(_fields, _param, _where);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        /// 更新
        /// </summary>
		 public ResultSet Update(QiangGou entity)
        {
            Func<QiangGou, ResultStatus> validate = (_entity) =>
            {
                return new ResultStatus();
            ...
            Func<QiangGou, ResultStatus> op = (_entity) =>
            {
                int ret = new QiangGouDal().Update(entity);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        public ResultSet DeleteList(string where)
        {
            ...
            {
                int ret = new QiangGouDal().DeleteList(_where);
                if (ret > 0)
                    return new ResultStatus();
                else
                    return new ResultStatus()
        ...
        {
            return new QiangGouDal().GetMaxField(filed);
        }
